...
export default function TermsPage() {
  return (
    <section className="max-w-3xl mx-auto py-16 text-gray-600">
      ...
      <p className="mb-4">All content, branding, and logos on this site are the property of AbsoluteAI Consulting or respective partners. Unpermitted reproduction or redistribution is prohibited.</p>
