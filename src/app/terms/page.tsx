...
export default function TermsPage() {
  return (
    <section className="max-w-3xl mx-auto py-16 text-gray-600">
      ...
      <p className="mb-6">By using the Absolute AI Consulting website, you agree to the following terms and conditions:</p>
      ...
      <p className="mb-4">All content, branding, and logos on this site are the property of Absolute AI Consulting or respective partners. Unpermitted reproduction or redistribution is prohibited.</p>
      <h2 className="text-xl font-semibold mt-8 mb-2">External Links</h2>
      <p className="mb-4">We may occasionally reference third-party sites. Absolute AI Consulting is not responsible for their content or privacy practices.</p>
