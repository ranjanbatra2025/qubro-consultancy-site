...
export default function PrivacyPage() {
  return (
    <section className="max-w-3xl mx-auto py-16 text-gray-600">
      ...
      <p className="mb-6">Absolute AI Consulting values your privacy. This policy outlines how we collect, use, and safeguard your data.</p>
    ...
    <p className="mb-4">Our website may use essential cookies for improved experience. You may adjust your browser settings to disable cookies, though some features may not function fully.</p>
      ...
      <p className="mb-4">If you purchase services through Stripe, we may store transaction and customer metadata in our database to manage fulfillment and support.</p>
