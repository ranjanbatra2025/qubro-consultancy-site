...
export default function Services() {
  const headingTextStyle = {
    ...
    display: 'inline-block', // Ensures background is tight to text, allows for centering if parent has text-align: center
    // Preserve existing text-shadow if any, or define a new one.
    // For this example, we'll let the original text-shadow (if any on parent) be,
    // or it might need specific adjustment if glow effects were intended on the new white text.
  };
  ...
  return (
    <>
      ...
      <section className="relative flex flex-col items-center justify-center text-center min-h-[80vh] py-24 bg-neutral-950 overflow-hidden">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-4 shadow-md animate-[fadeIn_1s_ease-out]">
          {/* Removed: bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-fuchsia-400 */}
          <span style={headingTextStyle}>Expert craftspeople. At your service.</span>
        </h1>
        <h2 className="text-4xl md:text-5xl font-bold mb-6 animate-[fadeIn_1.2s_ease-out]">
          {/* Removed: bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-fuchsia-400 */}
          <span style={headingTextStyle}>Our Services</span>
        </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="p-8 bg-neutral-950/50 backdrop-blur-md border border-neutral-800 rounded-2xl shadow-xl hover:scale-105 transition-transform duration-300 animate-[fadeIn_0.8s_ease-out]">
              ...
              <h2 className="text-3xl font-bold mb-4 text-center"> 
                {/* Removed: text-neutral-100. Added text-center to ensure span is centered if h2 is block */}
                <span style={headingTextStyle}>Generative AI</span>
              </h2>
            ...
            <div className="p-8 bg-neutral-950/50 backdrop-blur-md border border-neutral-800 rounded-2xl shadow-xl hover:scale-105 transition-transform duration-300 animate-[fadeIn_0.9s_ease-out]">
              ...
              <h2 className="text-3xl font-bold mb-4 text-center">
                {/* Removed: text-neutral-100. Added text-center */}
                <span style={headingTextStyle}>Agentic Systems</span>
              </h2>
              <p className="text-neutral-300 mb-6">
            ...
            <div className="p-8 bg-neutral-950/50 backdrop-blur-md border border-neutral-800 rounded-2xl shadow-xl hover:scale-105 transition-transform duration-300 animate-[fadeIn_1s_ease-out]">
              ...
              <h2 className="text-3xl font-bold mb-4 text-center">
                {/* Removed: text-neutral-100. Added text-center */}
                <span style={headingTextStyle}>Data Engineering</span>
              </h2>
              <p className="text-neutral-300 mb-6">
            ...
            <div className="p-8 bg-neutral-950/50 backdrop-blur-md border border-neutral-800 rounded-2xl shadow-xl hover:scale-105 transition-transform duration-300 animate-[fadeIn_1.1s_ease-out]">
              ...
              <h2 className="text-3xl font-bold mb-4 text-center">
                {/* Removed: text-neutral-100. Added text-center */}
                <span style={headingTextStyle}>Digital Marketing</span>
              </h2>
              <p className="text-neutral-300 mb-6">
            ...
            <div className="p-8 bg-neutral-950/50 backdrop-blur-md border border-neutral-800 rounded-2xl shadow-xl hover:scale-105 transition-transform duration-300 animate-[fadeIn_1.2s_ease-out]">
              ...
              <h2 className="text-3xl font-bold mb-4 text-center">
                {/* Removed: text-neutral-100. Added text-center */}
                <span style={headingTextStyle}>Product Development</span>
              </h2>
              <p className="text-neutral-300 mb-6">
      ...
      <style jsx>{`
        ...
        /* Ensure h2 within service cards are centered for the span to be centered */
        .grid .p-8 h2 {
            /* This is now handled by adding text-center directly to the h2 className */
        }
      `}</style>
    </>
  );
